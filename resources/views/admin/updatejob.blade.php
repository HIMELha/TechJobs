                    ...
                    <div class="col-lg-10 d-block mx-auto">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('adminjobs.updatee', $job->id) }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6  mb-4">
                                                ...
                                                <input type="number" min="1" placeholder="Vacancy" id="vacancy"
                                                    name="vacancy" value="{{ $job->vacancy }}"
                                        ...
                                        <div class="mb-4 col-md-6">
                                            ...
                                            <select id="status" name="status"
                                                ...
                                                <option value="{{ $job->status }}"
                                                    {{ $job->status == false ? 'selected' : '' }}>
                                                    Paused</option>
                                                <option value="{{ $job->status }}"
                                                    {{ $job->status == true ? 'selected' : '' }}>
                                                    Active</option>
